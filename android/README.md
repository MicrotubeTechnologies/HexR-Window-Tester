...
no Play Store account. A release APK would come out unsigned and refuse to
install. If this ever ships to customers rather than to technicians, that is the
point to add a real signing config.
